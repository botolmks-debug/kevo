...
const ONIMAGE_RULE_ID =
  ...
  "TANDA TITIK DUA (:) DILARANG di judul — titik dua bikin judul terkesan seperti label/kategori formal (\"Produk: Keunggulannya\"), bukan headline yang mengalir. Ganti dengan kalimat utuh, atau tanda \"—\" kalau memang perlu jeda. " +
...
const ONIMAGE_RULE_EN =
  ...
  "COLON (:) IS BANNED in the headline — a colon makes it feel like a formal label/category (\"Product: Its Benefits\"), not a flowing headline. Use a full sentence instead, or an em dash \"—\" if you genuinely need a pause. " +
