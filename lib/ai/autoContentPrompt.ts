...
const ONIMAGE_RULE_ID =
  ...
  "TANDA TITIK DUA (:) DILARANG di judul — titik dua bikin judul terkesan seperti label/kategori formal (\"Produk: Keunggulannya\"), bukan headline yang mengalir. Ganti dengan SATU kalimat utuh yang mengalir. " +
  "TANDA HUBUNG/DASH (\"--\", \"—\", \"–\") DILARANG KERAS di judul, dalam bentuk apa pun dan untuk alasan apa pun (termasuk sebagai pengganti titik dua atau jeda) — ini pola yang PALING SERING diulang-ulang dan bikin semua judul terkesan template/identik. Kalau butuh jeda, pakai koma, atau pecah jadi kalimat baru, atau susun ulang strukturnya. " +
  "KELENGKAPAN TATA BAHASA — jangan menghilangkan kata penghubung/pelengkap yang bikin frasa jadi janggal saat memadukan beberapa hal: contoh SALAH \"antara kualitas detail & plastik rapuh\" (bahasanya terpotong — \"plastik\" itu bahan, bukan sifat, jadi janggal disandingkan langsung dengan \"kualitas detail\"); contoh BENAR \"antara kualitas detail & bahan plastik yang rapuh\" (kata \"bahan\" dan \"yang\" melengkapi supaya kalimatnya mengalir natural). Baca ulang judulnya dalam hati sebelum menjawab: kalau ada kata yang kerasa \"hilang\"/dipaksa dipendekkan sampai janggal, tambahkan kata penghubungnya. " +
  "SINTESIS NAMA PRODUK vs JENIS PRODUK: kalau data produk kasih NAMA SPESIFIK (mis. \"Action figure Sano Manjiro\") DAN kategori/jenisnya (mis. \"mainan koleksi\"), judul harus terasa BENAR-BENAR MEMAHAMI apa barangnya — boleh sebut nama spesifiknya, tapi rangkai jadi kalimat berSUDUT/berINSIGHT (lihat pilihan struktur segar di bawah), bukan sekadar menempelkan nama produk mentah-mentah di depan kalimat generik. " +
...
const ONIMAGE_RULE_EN =
  ...
  "COLON (:) IS BANNED in the headline — a colon makes it feel like a formal label/category (\"Product: Its Benefits\"), not a flowing headline. Use ONE flowing sentence instead. " +
  "DASHES (\"--\", \"—\", \"–\") ARE STRICTLY BANNED in the headline, in any form and for any reason (including as a colon/pause substitute) — this is the MOST frequently repeated pattern and makes every headline feel templated/identical. If you need a pause, use a comma, split into a new sentence, or restructure the phrase entirely. " +
  "GRAMMATICAL COMPLETENESS — do not drop connecting/completing words that make a phrase feel awkward when combining several things: WRONG example \"between fine detail & fragile plastic\" (clipped — \"plastic\" is a material, not a trait, so it feels off paired directly with \"fine detail\"); RIGHT example \"between fine detail & the plastic's fragile build\" (the added words make it read naturally). Re-read the headline silently before answering: if a word feels \"missing\"/forced short to the point of awkwardness, add the connector back. " +
  "SYNTHESIZING PRODUCT NAME vs PRODUCT TYPE: if the product data gives a SPECIFIC NAME (e.g. \"Sano Manjiro action figure\") AND its category/type (e.g. \"collectible toy\"), the headline must feel like it genuinely UNDERSTANDS what the item is — you may name it specifically, but weave it into a sentence with an ANGLE/INSIGHT (see the fresh structures below), not just paste the raw product name in front of a generic sentence. " +
