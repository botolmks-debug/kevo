...
const DICT: Record<string, Entry> = {
  ...
  "login.notConfirmed": { id: "Emailmu belum dikonfirmasi. Cek inbox (dan folder spam) email yang kamu daftarkan, lalu klik link konfirmasinya sebelum masuk.", en: "Your email isn't confirmed yet. Check the inbox (and spam folder) of the email you signed up with, then click the confirmation link before signing in." },
