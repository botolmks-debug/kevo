...
/**
 * /video/cerita — ADMIN ONLY (proxy.ts + gerbang route API).
 ...
 * generatif (Veo/Seedance), jadi jauh lebih murah (±Rp3.000-3.500/video).
 *
      ...
      <main className="mx-auto max-w-3xl px-4 py-8 flex flex-col gap-6">
        <div>
          ...
          <p className="text-sm text-navy/60 mt-1">
            {SLIDE_COUNT} slide ({SLIDE_COUNT - 1} foto AI + fotomu) dengan narasi suara ElevenLabs, digabung jadi 1 video pendek. Bukan AI-video generatif — jauh lebih murah (±Rp3.000-3.500/video).
          </p>
        </div>
        ...
        <Card>
          ...
          <Button type="button" className="mt-4" disabled={!selected || sbStatus === "loading"} onClick={handleStoryboard}>
            {sbStatus === "loading" ? "Membuat storyboard..." : "2. Bikin Storyboard (4 token)"}
          </Button>
